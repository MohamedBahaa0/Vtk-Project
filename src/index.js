...
const controlview = `<select id="change_chart" name="example">
<option value="C">Please Choose A Window</option>
<option value="A">Skull</option>
<option value="B">Chest</option>
</select>`;

const fullScreenRendererbeforechoosing = vtkFullScreenRenderWindow.newInstance({
  background: [0, 0, 0],
});

fullScreenRendererbeforechoosing.addController(controlview);
...
function Skull() {
 ...
 <table>
   ...
   <tr>
   <tr>
   <td><button id="Buttonskull" type="button">skull</button></td>
   <td><button id="Buttonchest" type="button">chest</button></td>
   </tr>
   </tr>
     <tr>
       <td>Iso value</td>
 ...
 `;
  ...
  //document.querySelector("#Buttonchest").addEventListener("click", Chest)
  //document.querySelector("#Buttonskull").addEventListener("click", Skull)
  document.querySelectorAll("#Buttonskull").forEach(Buttonskull => {Buttonskull.addEventListener('click', function(){
    document.location.reload(true);
  })});
  document.querySelectorAll("#Buttonchest").forEach(Buttonskull => {Buttonskull.addEventListener('click', Chest)})
}
